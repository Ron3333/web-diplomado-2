        ...
        <?php
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST' ){
                ...
                if ($resultCheck->num_rows > 0) {
                    echo "<h2 class='text-center'>Ya usted esta registrado !!!!</h2>";
                    $conn->close();
                     exit();
                }
                ...
                echo" <h2 class='text-center'> Error, algunos campos están vacíos </h2>";
                exit();
                ...
                if ($conn->query($sql) === TRUE) {
                    echo "<h2 class='text-center'>Registro exitoso. Ahora puedes <a href='login.php'>iniciar sesión</a>.</h2>";
                } else {
                    echo "<h2 class='text-center'>Error AEP: " . $conn->error . "</h2>";
                }
